...
UI.handleNetworkSpamming = function() {
    ...
    $(document).on("closed", "#spam-modal", function (e) {
        if (isSpamming) {
            ...
            flkd.api.interruptAttachingToTangle(function() {
    ...
    $("#spam-btn").on("click", function(e) {
        ...
        async.doWhilst(function(callback) {
            ...
            flkd.api.getNodeInfo(function(error, nodeInfo) {
                ...
                if (nodeInfo.latestSolidSubtangleMilestoneIndex === nodeInfo.latestMilestoneIndex) {
                    ...
                    flkd.api.sendTransfer("999999999999999999999999999999999999999999999999999999999999999999999999999999999", connection.depth, connection.minWeightMagnitude, [{"address": "999999999999999999999999999999999999999999999999999999999999999999999999999999999", "value": 0, "tag": spamTag}], function(error) {
                        if (!error) {
