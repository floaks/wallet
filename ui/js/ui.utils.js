var UI = (function(UI, $, undefined) {
  ...
  UI.formatAmount = function(amount) {
    ...
    /*
    1 Kflkd = 10³ flkd = 1,000 flkd
    1 Mflkd = 10⁶ flkd = 1,000,000 flkd
    1 Gflkd = 10⁹ flkd = 1,000,000,000 flkd
    1 Tflkd = 10¹² flkd = 1,000,000,000,000 flkd
    1 Pflkd = 10¹⁵ flkd = 1,000,000,000,000,000 flkd
    */
  ...
  UI.notifyDesktop = function(message, options, ifNotFocused) {
    ...
    if (!("Notification" in window)) {
      ...
      var notification = new Notification("flkd Wallet", {"body": parsedMessage});
  ...
  UI.updateSettings = function(settings) {
    ...
    if (changeNode) {
      flkd.changeNode({"host": connection.host, "port": connection.port});
    ...
    if (settings.hasOwnProperty("addedNodes") && settings.addedNodes.length) {
      flkd.api.addNeighbors(settings.addedNodes, function(error, addedNodes) {
    ...
    if (settings.hasOwnProperty("removedNodes") && settings.removedNodes.length) {
      flkd.api.removeNeighbors(settings.removedNodes, function(error, removedNodes) {
