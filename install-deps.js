...
var req = https.get({"host"    : "api.github.com", 
                     "path"    : "/repos/floaks/ccurl/releases/latest",
                     "headers" : {"User-Agent": "flkd Wallet"}}, function(res) {
...
var download = function(url, dest, cb) {
  ...
  var req = https.get({"host"   : parsed.host, 
                       "path"   : parsed.path,
                       "headers": {"user-agent": "flkd Wallet", "Accept": "application/octet-stream"}}, function(response) {
    response.pipe(file);
